...
HRESULT InitEnemy(int min, int max)
{
	...
	for (int i = 0; i <= kazu; i++)
	{
		...
		if (i % 3 == 0)
		{
			g_Enemy[i].pos = XMFLOAT3(200.0f + i * 1000.0f, 100.0f, 0.0f);	// 中心点から表示
		}
		else if (i % 3 == 1)
		{
			g_Enemy[i].pos = XMFLOAT3(200.0f + i * 1000.0f, 500.0f, 0.0f);	// 中心点から表示
		}
		else
		{
			g_Enemy[i].pos = XMFLOAT3(200.0f + i * 1000.0f, 900.0f, 0.0f);	// 中心点から表示
		}
