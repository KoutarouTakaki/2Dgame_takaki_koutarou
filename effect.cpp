...
#define EFFECT_TEXTURE_SIZE_X	(200)		// テクスチャサイズ
#define EFFECT_TEXTURE_SIZE_Y	(200)		// 同上

#define EFFECT_TEXTURE_PATTERN_DIVIDE_X	(8)	// アニメパターンのテクスチャ内分割数（X)
